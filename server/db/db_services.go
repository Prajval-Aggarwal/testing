...
func ResponseQuery(query string, args ...interface{}) response.PlayerResposne {
	...
	row.Scan(&playerResposne.PlayerId, &playerResposne.PlayerName, &playerResposne.Level, &playerResposne.XP, &playerResposne.Role, &playerResposne.Email, &playerResposne.Coins, &playerResposne.Cash, &playerResposne.RepairParts, &playerResposne.CarsOwned, &playerResposne.GaragesOwned, &playerResposne.DistanceTraveled, &playerResposne.ShdWon, &playerResposne.ShdWinRatio, &playerResposne.TdWon, &playerResposne.TdWinRatio)
